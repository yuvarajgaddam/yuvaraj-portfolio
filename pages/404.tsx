  ...
  return (
    <>
      ...
      <div className="bg-bglight dark:bg-bgdark overflow-hidden">
        <div className="h-screen flex flex-col justify-center selection:bg-marrsyellow selection:text-bglight dark:selection:bg-carriyellow dark:selection:text-bgdark">
          <div className="flex justify-center items-center flex-col mt-auto">
            <h1 className="text-8xl xs:text-9xl font-bold text-marrsyellow dark:text-carriyellow">
              404
            </h1>
