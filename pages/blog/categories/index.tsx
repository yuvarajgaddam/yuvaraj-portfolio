...
const Blog: NextPage<Props> = ({ categories, categorizedPosts }) => {
  ...
  return (
    <>
      <AppHead title="Blog - Yuvaraj Gaddam" />
            ...
            <section className="blog-section">
              ...
              {categories.map((category) => (
                <div key={category} className="my-4">
                  ...
                  >
                    <h2 className="category-title overflow-hidden text-xl font-medium pl-2 border-l-4 hover:text-marrsyellow dark:hover:text-carriyellow border-marrsyellow dark:border-carriyellow">
