...
const Footer: React.FC<Props> = () => {
  return (
    <footer
      className="pb-24 md:pb-4 text-center mt-auto"
    >
...
const socialLinks = [
  {
    id: 1,
    title: "Yuvaraj Gaddam's Github Profile",
    ...
    svg: (
      <svg
        ...
        width="24"
        height="24"
        className="dark:fill-bglight hover:fill-marrsyellow dark:hover:fill-carriyellow"
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
  ...
  {
    id: 2,
    title: "Yuvaraj Gaddam's LinkedIn Profile",
