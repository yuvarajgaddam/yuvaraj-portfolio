          ...
          <nav className="flex items-center">
              ...
              <ul className="flex justify-evenly items-center py-1">
                {navLinks.map((navLink) => (
                  ...
                  >
                    <Link
                      href={navLink.url}
                      className={`text-sm md:text-lg flex flex-col items-center w-[4.5rem] md:w-auto md:mr-6  dark:fill-textlight md:hover:text-marrsyellow md:dark:hover:text-carriyellow link-outline
                        ${
                          router.pathname === navLink.url &&
                          "text-marrsyellow dark:text-carriyellow fill-marrsyellow dark:fill-carriyellow"
                        }`}
                    >
            ...
            >
              <svg
                ...
                width="24"
                height="24"
                className="fill-textlight hidden dark:inline-block transform scale-110 md:dark:hover:fill-carriyellow"
              >
              ...
              <svg
                ...
                width="24"
                height="24"
                className="dark:hidden transform scale-90 md:hover:fill-marrsyellow "
              >
