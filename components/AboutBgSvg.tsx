...
const AboutBgSvg: React.FC = () => {
  return (
    <>
      ...
      >
        <Image src={dots} width={102} height={153} alt="dots background" loading="lazy"/>
      </span>
      <span
        aria-hidden="true"
        className="bg-svg absolute bottom-12 -left-12 hidden lg:dark:inline-block"
      >
        <Image src={dotsDark} width={102} height={153} alt="dots background" loading="lazy"/>
      </span>
      <span
        aria-hidden="true"
      ...
      >
        <Image src={arrow} width={19} height={60} alt="up arrow" loading="lazy"/>
      </span>
    </>
  );
};
