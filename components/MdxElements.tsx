...
export const Ul = (props: any) => (
  <ul
    className="marker:text-marrsyellow dark:marker:text-carriyellow list-disc pl-4 space-y-1 mt-1"
    {...props}
  />
);
...
export const Ol = (props: any) => (
  <ol
    className="marker:text-marrsyellow dark:marker:text-carriyellow list-decimal pl-4 space-y-1 mt-1"
    {...props}
  />
);
